...
- any readable skill at any depth may also be auto-injected into prompt context when its frontmatter sets `metadata.loaded` and that condition passes against the live document skill-context tags
