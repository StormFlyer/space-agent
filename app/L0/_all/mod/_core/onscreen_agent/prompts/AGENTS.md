...
- `system-prompt.md` should stay focused on overlay-wide protocol and runtime-generic execution behavior; module-specific helper names, staged workflows, and feature policy belong in owner-module auto-loaded skills or owner-module `_core/onscreen_agent/...` prompt extensions instead of the base firmware prompt
